...
[REASON_EQUAL_BIT_INDEX]                 = N_("Files are equal"),
[REASON_IGNORED_BIT_INDEX]               = N_("Matches an ignore pattern"),
[REASON_MISSING_BIT_INDEX]               = N_("File does not exist in the original folder"),
[REASON_NEW_BIT_INDEX]                   = N_("New file found in the original folder"),
[REASON_HARDLINK_BIT_INDEX]              = N_("Hardlinked file in the original folder"),
[REASON_HARDLINK_NOT_REGULAR_BIT_INDEX]  = N_("Backup item is not a regular file"),
[REASON_HARDLINK_MISSING_LINK_BIT_INDEX] = N_("Backup item is missing link target"),
[REASON_HARDLINK_NOT_MATCH_BIT_INDEX]    = N_("Link targets do not match"),
[REASON_SYMLINK_BIT_INDEX]               = N_("Symlink in the original folder"),
[REASON_SYMLINK_NO_TARGET_BIT_INDEX]     = N_("Could not resolve link to check"),
[REASON_SYMLINK_NOT_BIT_INDEX]           = N_("Destination is not a symlink"),
[REASON_SYMLINK_NOT_MATCH_BIT_INDEX]     = N_("Symbolic link targets do not match"),
[REASON_SIZE_BIT_INDEX]                  = N_("File sizes differ"),
[REASON_MTIME_NEWER_BIT_INDEX]           = N_("File in the source is newer than backup"),
[REASON_MTIME_OLDER_BIT_INDEX]           = N_("File in the source is older than backup"),
[REASON_CTIME_BIT_INDEX]                 = N_("Metadata change times differ"),
[REASON_OWNER_BIT_INDEX]                 = N_("Owners differ"),
[REASON_GROUP_BIT_INDEX]                 = N_("Groups differ"),
[REASON_PERM_BIT_INDEX]                  = N_("Permissions differ"),
[REASON_TYPE_BIT_INDEX]                  = N_("Item types differ"),
};

static char *reason_strings_dir[] = {
[REASON_EQUAL_BIT_INDEX]                 = N_("Folders are equal"),
[REASON_IGNORED_BIT_INDEX]               = N_("Matches an ignore pattern"),
[REASON_MISSING_BIT_INDEX]               = N_("Folder does not exist in the original folder"),
[REASON_NEW_BIT_INDEX]                   = N_("New folder found in the original folder"),
[REASON_HARDLINK_BIT_INDEX]              = N_("Hardlinked folder in the original folder"),
[REASON_HARDLINK_NOT_REGULAR_BIT_INDEX]  = N_("Backup item is not a regular file"),
[REASON_HARDLINK_MISSING_LINK_BIT_INDEX] = N_("Backup item is missing link target"),
[REASON_HARDLINK_NOT_MATCH_BIT_INDEX]    = N_("Link targets do not match"),
[REASON_SYMLINK_BIT_INDEX]               = N_("Symlink in the original folder"),
...
[REASON_SYMLINK_NOT_BIT_INDEX]           = N_("Destination is not a symlink"),
[REASON_SYMLINK_NOT_MATCH_BIT_INDEX]     = N_("Symbolic link targets do not match"),
[REASON_SIZE_BIT_INDEX]                  = N_("Folder sizes differ"),
[REASON_MTIME_NEWER_BIT_INDEX]           = N_("Folder in the source is newer than backup"),
[REASON_MTIME_OLDER_BIT_INDEX]           = N_("Folder in the source is older than backup"),
[REASON_CTIME_BIT_INDEX]                 = N_("Metadata change times differ"),
[REASON_OWNER_BIT_INDEX]                 = N_("Owners differ"),
[REASON_GROUP_BIT_INDEX]                 = N_("Groups differ"),
[REASON_PERM_BIT_INDEX]                  = N_("Permissions differ"),
