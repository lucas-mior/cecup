...
#define ENUM_ELEMENT(...) SELECT_ON_NUM_ARGS(ENUM_ELEMENT_HANDLER_, __VA_ARGS__)
  ...
  #define ENUM_ELEMENT_HANDLER_1(e) \
      case CAT(CAT(ENUM_NAME_LOCAL, _), e): return QUOTE(ENUM_NAME_LOCAL) "_" #e;

  #define ENUM_ELEMENT_HANDLER_2(e, v) \
      case CAT(CAT(ENUM_NAME_LOCAL, _), e): \
          return _Generic((v), \
              char*: (char*)(v), \
              default: QUOTE(ENUM_NAME_LOCAL) "_" #e \
          );

  #define ENUM_ELEMENT_HANDLER_3(e, v, s) \
      case CAT(CAT(ENUM_NAME_LOCAL, _), e): return s;
